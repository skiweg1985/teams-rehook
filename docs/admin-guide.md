...
On startup, the backend creates a default organization and bootstrap admin if they do not exist. The values come from:
...
Change bootstrap credentials and `SESSION_SECRET` before any production-like use.
